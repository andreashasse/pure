---
name: release
description: Prepare and publish a new release of pure_fun. Updates CHANGELOG.md, mix.exs, and README.md with version information, analyzes git commits to determine semantic version, and guides through the release process.
---

# Release Skill

You are helping to prepare a new release of the pure_fun library.
...
### README.md
- Find and update the installation example: `{:pure_fun, "~> X.Y.Z", runtime: false}`
...
- Do NOT run `task release` — the user will do that after the PR is merged
- Do NOT create git tags — `task release` handles tagging and publishing
